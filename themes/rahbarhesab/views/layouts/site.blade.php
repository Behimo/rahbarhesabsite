...
<body class="rh-theme">
    ...
    <main @class(['rh-inner-page' => ! request()->routeIs(['home', 'courses.index', 'courses.show', 'blog.*', 'panel.*', 'login', 'login.verify', 'cart.index', 'checkout.index', 'checkout.success', 'checkout.failed'])])>
        @yield('page')
    </main>
