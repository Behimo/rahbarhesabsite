...
class SiteDataService
{
    ...
    public function aboutTimeline(): array
    {
        return [
            ...
            ['year' => '۲۰۲۴', 'title' => 'بیسان امروز', 'desc' => '۴ محصول فعال + پروژه اختصاصی برای مشتریان'],
        ];
    }
    ...
    public function aboutPillars(): array
    {
        return [
            ...
            ['icon' => 'M13 10V3L4 14h7v7l9-11h-7z', 'text' => '۴ محصول که هر روز در دست مشتریان واقعی است'],
    ...
    public function contactFaq(): array
    {
        return [
            ...
            ['q' => 'آیا می‌توانم محصول را قبل از خرید ببینم؟', 'a' => 'حتماً. دمو رایگان برای همه محصولات داریم — کافی است فرم تماس را پر کنید.'],
        ];
    }
    ...
    public function defaultPageMeta(): array
    {
        return [
            'home' => [
                ...
                'description' => 'بیسان — ۴ محصول آماده برای فروش و خدمات، یا پروژه اختصاصی برای کسب‌وکار شما. مشاوره رایگان.',
                'keywords' => 'بیسان, BISAN, CRM, راهبر, نوژارو, ویلئو, نرم‌افزار, ایران',
                'og_title' => 'بیسان — نرم‌افزار درست برای رشد کسب‌وکار شما',
            ],
            'products' => [
                'title' => 'محصولات بیسان | راهبر، نوژارو، ویلئو، افزونه وردپرس',
                'description' => 'محصولات نرم‌افزاری بیسان: راهبر CRM، نوژارو، ویلئو برای مدیریت مالی شخصی و افزونه وردپرس برای اتصال سایت به CRM.',
                'keywords' => 'راهبر CRM, نوژارو, ویلئو, افزونه وردپرس, نرم‌افزار فروش, بیسان',
            ...
            'about' => [
                ...
                'description' => 'بیسان تیم برنامه‌نویسی با ۴ محصول فعال و بیش از ۱۰ سال تجربه در بازار ایران.',
